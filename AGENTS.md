...
- The desired immutable-tag ruleset is described in `.github/rulesets/immutable-tags.json`; it requires a separate administrative action. Protect all tags from update/deletion without restricting first creation, and do not register bypass actors.
